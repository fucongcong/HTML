...
## HTML布局
网页布局对改善网站的外观非常重要。是啊，但如何实现呢？

### CSS
你可以使用级联样式表（简称CSS）为网站设计页面布局。本课将对CSS作简单介绍。

HTML负责网页的具体内容（结构），而CSS则修饰网页的表现形式（布局）。

我们可以用style属性将CSS内联到网页中。
如：
````
...
## 结束语
HTML的基础已经给大家介绍完了，具体的深入还是需要大家自己多写写代码，当然接下来你就可以学习我们的CSS课程，如果想快速开发自己的网站也可以学习Ｂootstrap课程，当然要学会制作一个动态网站，可以学习我们的PHP课程。
